...
(function ($) {
	 ...
	 * Close the modal dialog.
	 */
	$.modal.persistClose = function () {
		$.modal.impl.persistClose();
	};
	...
	$.modal.impl = {
		...
		create: function (data) {
			...
			var myContainer = $('#'+s.o.containerId);
			if (!myContainer.length){
				...
				s.d.container = myContainer;
				s.d.wrap = myContainer.find('.simplemodal-wrap');
				s.d.data = myContainer.find('.simplemodal-data');
			}
		...
		persistClose: function () {
			...
			if ($.isFunction(s.o.onClose) && !s.occb) {
				...
				// remove the remaining elements
				s.d.container.addClass('persist-hidden');
				s.d.overlay.hide();
				// s.d.iframe && s.d.iframe.hide().remove();
				s.d.overlay.remove();
